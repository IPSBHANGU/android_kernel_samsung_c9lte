...
if [ "${REGION}" == "${CARRIER}" ]; then
	...
	VARIANT_DEFCONFIG=msm8976_sec_${MODEL}_${REGION}_${CARRIER}_defconfig
fi
...
FUNC_BUILD_KERNEL()
{
    ...
    echo '--base 0x80000000 --cmdline "console=null androidboot.hardware=qcom msm_rtb.filter=0x237 ehci-hcd.park=3 androidboot.bootdevice=7824900.sdhci lpm_levels.sleep_disabled=1 earlyprintk" --pagesize 2048 --tags_offset 0x01E00000 --ramdisk_offset 0x02000000 --os_version 8.0.0 --os_patch_level 2018-04-01'   >  $PRODUCT_OUT/mkbootimg_ver_args.txt   
